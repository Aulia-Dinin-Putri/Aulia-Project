		...
		<div class="small-box bg-green">
			<div class="inner" style="height: 100px">
				...
				<div class="icon"><i class="fa fa-user"></i></div>
					<a href="<?= base_url('admin/pegawai') ?>" class="small-box-footer">More info
    ...
    <div class="col-lg-4 col-xs-12">
        ...
        <div class="inner"style="height: 100px">
            ...
            <div class="icon"><i class="fa fa-address-card"></i></div>
				<a href="<?= base_url('admin/gaji') ?>" class="small-box-footer">More info
					<i class="fa fa-arrow-circle-right"></i>
				</a>
        </div>
    </div>
    <div class="col-lg-4 col-xs-12">
        ...
        <div class="inner" style="height: 100px">
            ...
            <div class="icon"><i class="fa fa-users"></i></div>
				<a href="<?= base_url('admin/kelpeg') ?>" class="small-box-footer">More info
					<i class="fa fa-arrow-circle-right"></i>
				</a>
        </div>
    </div>
    <div class="col-lg-4 col-xs-12">
        ...
        <div class="inner" style="height: 100px">
            ...
            <div class="icon"><i class="fa fa-cubes"></i></div>
				<a href="<?= base_url('admin/menu_pengangkatan') ?>" class="small-box-footer">More info
					<i class="fa fa-arrow-circle-right"></i>
				</a>
        </div>
    </div>
	...
	<div class="col-lg-4 col-xs-12">
        ...
        <div class="inner" style="height: 100px">
            ...
            <div class="icon"><i class="fa fa-star"></i></div>
				<a href="<?= base_url('admin/penghargaan') ?>" class="small-box-footer">More info
					<i class="fa fa-arrow-circle-right"></i>
				</a>
        </div>
    </div>	
    <div class="col-lg-4 col-xs-12">
        ...
        <div class="inner" style="height: 100px">
            ...
            <div class="icon"><i class="fa fa-database" ></i></div>
				<a href="<?= base_url('admin/menu_riwayat') ?>" class="small-box-footer">More info
					<i class="fa fa-arrow-circle-right"></i>
				</a>
        </div>
    </div>
