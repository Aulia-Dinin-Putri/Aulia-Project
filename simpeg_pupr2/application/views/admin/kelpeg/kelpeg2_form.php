...
<tr><th>Nama Istri/Suami</th><td><input type="text" name="nama_is" value="<?= $nama_is ?>" class="form-control"></td></tr>
<tr><th>Tempat Lahir Istri/Suami</th><td><input type="text" name="tempat_is" value="<?= $tempat_is ?>" class="form-control" ></td></tr>
<tr><th>Tanggal Lahir Istri/Suami</th><td><input type="date" name="tgllahir_is" value="<?= $tgllahir_is ?>" class="form-control"></td></tr>
<tr><th>Tanggal Kawin</th><td><input type="date" name="tgl_kawin" value="<?= $tgl_kawin ?>" class="form-control" ></td></tr>
<tr><th>Pendidikan Akhir Istri/Suami</th><td><select class="form-control" name="pend_akhir" value="<?= $pend_akhir ?>" >
...
<tr><th>Pekerjaan Istri/Suami</th><td><input type="text" name="pekerjaan_is" value="<?= $pekerjaan_is ?>" class="form-control" ></td></tr>
<tr><th>Nip Istri/Suami</th><td><input type="number" name="nip_is" value="<?= $nip_is ?>" class="form-control"></td></tr>
<tr><th>Pangkat Istri/Suami</th><td><input type="text" name="pangkat" value="<?= $pangkat ?>" class="form-control"></td></tr>
<tr><th>No KK</th><td><input type="number" name="no_kk" value="<?= $no_kk ?>" class="form-control"></td></tr>
<tr><th>NIK Istri/Suami</th><td><input type="number" name="nik_is" value="<?= $nik_is ?>" class="form-control"></td></tr>
<tr><th>OPD</th><td><input type="text" name="opd" value="<?= $opd ?>" class="form-control"></td></tr>
<tr><th>Nama Anak</th><td><input type="text" name="nama_anak1" value="<?= $nama_anak1 ?>" class="form-control"></td></tr>
<tr><th>Tempat Lahir Anak</th><td><input type="text" name="tempat_anak1" value="<?= $tempat_anak1 ?>" class="form-control"></td></tr>
<tr><th>Tanggal Lahir Anak</th><td><input type="date" name="tgllahir_anak1" value="<?= $tgllahir_anak1 ?>" class="form-control"></td></tr>
<tr><th>Pekerjaan Anak</th><td><input type="text" name="pekerjaan_anak1" value="<?= $pekerjaan_anak1 ?>" class="form-control"></td></tr>
...
<tr><td></td><td><input type="submit" name="kirim" value="Submit" class="btn btn-primary">
	<a href="<?= base_url('admin/kelpeg') ?>" class="btn btn-success" class="small-box-footer">Back <i class="fa fa-arrow-circle-right"></i></a>
</td></tr>
