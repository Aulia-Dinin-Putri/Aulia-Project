...
<table id="example1" class="table table-striped table-bordered">
	...
	<td><?= $tempat_ibu ?></td>
		 ...
		 <td width="70" text align="center">:</td>
		 <td><?= $tgllahir_anak3 ?></td>
		 </tr>
		 <tr>
		 <td>Pekerjaan Anak-3</td>
		 <td width="70" text align="center">:</td>
		 <td><?= $pekerjaan_anak3 ?></td>
		 </tr>
...
?>
<tr><td></td><th><a href="<?= base_url('admin/kelpeg') ?>" class="btn btn-primary" class="small-box-footer">Back <i class="fa fa-arrow-circle-right"></i></a></th></tr>
</form>
</table>
<?php 
if($aksi == "edit"):
