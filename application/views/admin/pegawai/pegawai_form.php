...
<tr><th>No HP</th><td><input type="text" name="no_hp" value="<?= $no_hp ?>" class="form-control" required=""></td></tr>
...
<tr><td></td><td><input type="submit" name="kirim" value="Submit" class="btn btn-primary"> &nbsp;&nbsp;<input type="return" name="g" value="Batal" class="btn btn-danger"></td></tr>
