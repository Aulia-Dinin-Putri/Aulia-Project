...
<tr><th>Nama Pegawai</th><td><input type="text" name="nama" value="<?= $nama ?>" class="form-control" required=""></td><th class="text-danger">***</th></tr>
...
<tr><th>Nama Anak-1</th><td><input type="text" name="nama_anak1" value="<?= $nama_anak1 ?>" class="form-control" required=""></td></tr>
<tr><th>Tempat Lahir Anak-1</th><td><input type="text" name="tempat_anak1" value="<?= $tempat_anak1 ?>" class="form-control" required=""></td></tr>
<tr><th>Tanggal Lahir Anak-1</th><td><input type="date" name="tgllahir_anak1" value="<?= $tgllahir_anak1 ?>" class="form-control" required=""></td></tr>
<tr><th>Pekerjaan Anak-1</th><td><input type="text" name="pekerjaan_anak1" value="<?= $pekerjaan_anak1 ?>" class="form-control" required=""></td></tr>
<tr><th>Status Anak-1</th><td><select class="form-control" name="status_anak1" value="<?= $status_anak1 ?>" required="">
	                          <option value="-">-</option>
							  <option value="AK">AK</option>
	                          <option value="AT">AT</option>
							  <option value="AA">AA</option>
                              </select></td></tr>
<tr><th>Pendidikan Anak-1</th><td><select class="form-control" name="pend_anak1" value="<?= $pend_anak1 ?>" required="">
	                          <option value="-">-</option>
...
<tr><th>Jenis Kelamin Anak-1</th><td><select class="form-control" name="jk_anak1" value="<?= $jk_anak1 ?>" required="">
	                          <option value="-">-</option>
...
<tr><td></td><td><input type="submit" name="kirim" value="Submit" class="btn btn-primary">
	<a href="http://localhost/simpeg_pupr/admin/kelpeg" class="btn btn-success" class="small-box-footer">Back <i class="fa fa-arrow-circle-right"></i></a>
</td></tr>
