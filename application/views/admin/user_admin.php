<a href="<?= base_url('admin/user_admin_tambah/') ?>" class="btn btn-primary">Tambah  Hak Akses</a> <a href="user_admin"> <button onClick="window.print();" class="btn btn-warning" ><i class="fa fa-print"></i>Print Data</button></a>
<br /><br /><br />
