...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1"> <!-- layar bisa diperbesar-->
...
<?php if($this->session->userdata('level') == "admin"){ ?>
	  ...
	  <li><a href="<?= base_url('admin/kelpeg') ?>" class="active"><i class="fa fa-circle-o"></i>Keluarga Pegawai</a></li>
	  <li><a href="<?= base_url('admin/gaji') ?>" class="active"><i class="fa fa-circle-o"></i>Penggajian Pegawai</a></li>
	  <li><a href="<?= base_url('admin/menu_pengangkatan') ?>" class="active"><i class="fa fa-circle-o"></i>Pengangkatan Pegawai</a></li>
	  <li><a href="<?= base_url('admin/penghargaan') ?>" class="active"><i class="fa fa-circle-o"></i>Penghargaan Pegawai</a></li>
          </ul>
        </li>
  ...
  <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('grafik/banding_jk'); ?>"><i class="fa fa-circle-o"></i> Perbandingan Jenis Kelamin</a></li>
             <li><a href="<?= base_url('grafik/banding_pendidikan'); ?>"><i class="fa fa-circle-o"></i> Perbandingan Pendidikan</a></li>
...
<?php }elseif($this->session->userdata('level') == "user"){ ?>
	...
	<li class="treeview">
		...
		<li class="treeview">
			<a href="#">
            <i class="fa fa-circle-o"></i> <span>Pengangkatan Pegawai</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
         <li><a href="<?= base_url('admin/pengangkatancpns_read') ?>" class="active"><i class="fa fa-circle-o"></i>Pengangkatan Pegawai CPNS</a></li> 
		 <li><a href="<?= base_url('admin/pengangkatanpns_read') ?>" class="active"><i class="fa fa-circle-o"></i>Pengangkatan Pegawai PNS</a></li> 
          </ul>
        </li>
	  <li><a href="<?= base_url('admin/penghargaan_read') ?>" class="active"><i class="fa fa-circle-o"></i>Penghargaan Pegawai</a></li>
      

		<li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o"></i> <span>Riwayat Pegawai</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
         <li><a href="<?= base_url('admin/jabatan_read') ?>" class="active"><i class="fa fa-circle-o"></i>Jabatan</a></li>
		 <li><a href="<?= base_url('admin/pendidikan_read') ?>" class="active"><i class="fa fa-circle-o"></i>Pendidikan Pegawai</a></li> 
		 <li><a href="<?= base_url('admin/diklatstruktural_read') ?>" class="active"><i class="fa fa-circle-o"></i>Diklat Struktural Pegawai</a></li> 
          </ul>
        </li>
